...
class Grid:
    ...
    def get_positions(self):
        ...
        for i in range(9):
            for j in range(9):
                positions[i][j] = (self.x + (j * self.square_l) + padding + 5, self.y + (i * self.square_l) + padding)
        return positions
    ...
    def round(self, grid):
        ...
        while running:
            ...
            if running:
                ...
                screen.blit(number_text, (WIDTH * 6 // 16, HEIGHT * 3 // 48))
                ...
                for event in pg.event.get():
                    if event.type == pg.QUIT:
                        pg.quit()
                        sys.exit()
                    elif event.type == pg.USEREVENT:  # Song ended
                        grid.play_music()
        ...
        while True:
            ...
            screen.blit(message_text, (WIDTH // 6, HEIGHT // 2))
            pg.display.flip()
